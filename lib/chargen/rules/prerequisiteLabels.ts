...
const FIXED_LABELS: Record<string, string> = {
  ...
  KULTURKUNDE: "Requires Culture Lore for a related culture",
  STUFEN: "Requires a valid rating/stage",
  STANDARD: "Standard requirements",
  TALENT: "Requires a talent selection",
  VZ: "Requires Spellcaster (full) or Quarter-Spellcaster",
  Z: "Requires Spellcaster (full)",
  ZWEISTIMMIGER_GESANG: "Requires Two-Voiced Singing",
  GEFAHRENINSTINKT: "Requires Danger Sense",
  MAGIEGESPUER: "Requires Magic Sense",
  PROPHEZEIEN: "Requires Prophesy",
  ZWERGENNASE: "Requires Dwarfnose",
